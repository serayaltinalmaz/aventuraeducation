const countries = [
  ...
  function biggest(){
  var biggestCountry = countries.reduce((acc, country) => {
  ...
  document.getElementById("1").innerHTML ="En çok nüfusa sahip ülke:" + biggestCountry["name"];
  }

  function small(){
  var smallCountry = countries.reduce((acc, country) => {
    if (country.population < acc.population) {
      return country;
    } else {
      return acc;
  ...
  document.getElementById("1").innerHTML ="En az nüfusa sahip ülke:" + smallCountry["name"];
  }

  function language(){
  var englishSpeakingCountries = countries.filter(country => country.languages.includes("English"));
  var countryNames = englishSpeakingCountries.map(country => country.name);
  console.log(countryNames);
  document.getElementById("1").innerHTML ="Dili ingilizce olan ülkeler:" + countryNames;
  }

  function money(){
  var currencyCountries = countries.filter(country => country.currency.includes("Euro") || country.currency.includes("pound"));
  var currencyCountry= currencyCountries.map(country => country.name);
  console.log(currencyCountry);
  document.getElementById("1").innerHTML ="Euro ve Pound kullanan ülkeler:" + currencyCountry;
  }
