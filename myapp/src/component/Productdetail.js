    ...
    return (
        <div className='detpage'>
            ...
            <div className='heart' onClick={() => {
                ...
                <div className='lotdetpage'><Lottie
                    loop={false}
                    segments={likesegment}
                    animationData={likeanimation}
                    play
                    style={{ width: 80, height: 80 }} /> </div></div>
            <div className='detpagedet'>
                ...
                <button className='addtobasketdetpage' onClick={() => {
                        let tempBasket = [...basket];
                        let items = tempBasket.find(item => item.id === selectedProduct.id);
                        if (items === undefined) {
