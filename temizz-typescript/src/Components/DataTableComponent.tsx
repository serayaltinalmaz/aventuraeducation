...
// type UserType = Accounts & {          accountsu da dahil eder
//     email: string; 
// }
type Phone = {
    phone: string
...
const DataTableComponent = () => {
    ...
    const AccountBodyTemplate = (account: Accounts) => {
    ...
    const SubjectBodyTemplate = (subjects: Subject) => {
        return <p> {subjects.subject} </p>
    };
    const MessageBodyTemplate = (messages: Message) => {
