...
type SupportDataContextValue = {
    SupportFakeData: SupportData[];
    setSupportFakeData: React.Dispatch<React.SetStateAction<SupportData[]>>;
};

export const SupportFakeDataContext = createContext<SupportDataContextValue>({} as SupportDataContextValue);

const SupportDataProvider = ({ children }: PropsWithChildren<{}>) => {
    const [SupportFakeData, setSupportFakeData] = useState<SupportData[]>(SupportFakeDataObj);
...
export default SupportDataProvider;

const SupportFakeDataObj: SupportData[] = [
    {
        "id": 1,
        "firstName": "Torey",
        "lastName": "Courtin",
